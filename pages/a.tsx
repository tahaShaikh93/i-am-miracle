  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        <Overlay>
<div className="overlay__team">
    <section  className="container-2xl bg-slate-900 bg-opacity-90 bg-clip-padding mx-auto" id="home__team">
        <div className="flex lg:items-center md:items-start flex-wrap xl:w-9/12 mx-auto py-44">
            <div className="md:w-6/12 w-full mx-7 sm:mx-7 md:mx-0 lg:mx-0 xl:mx-0">
                <h2 className="text-sm md:text-sm lg:text-lg xl:text-lg text-text-primary font-medium font-sans leading-relaxed">OUR TEAM</h2>
                <h1 className="text-2xl md:text-4xl lg:text-4xl xl:text-4xl text-white font-medium font-sans leading-relaxed mb-5 mt-3">We're a team of designers, engineers and analysts</h1>
                <p className="text-white text-opacity-60 text-lg leading-relaxed">Our team consists of many creative people. We are committed to maintaining quality work as well as speed. These creative people work together to create maximum work results.</p>
            </div>
            <div className="md:w-6/12 w-full mb-10 md:mb-0 mx-7 sm:mx-7 md:mx-0 lg:mx-0 xl:mx-0">
                <img src="img/Welcome-banner-img.svg" className="w-full" />
            </div>
        </div>
    </section>
            </div>
            {/* <div className="overlay__about">
    <section  className="container-2xl bg-slate-900 bg-opacity-90 bg-clip-padding mx-auto" id="home__about">
       
            <div className="md:w-6/12 w-full mb-10 md:mb-0 mx-7 sm:mx-7 md:mx-0 lg:mx-0 xl:mx-0">
                <img src="img/orange-banner-cartoon.svg" className="w-full" />
            </div>
          ...
          <div className="relative">
            ...
            <div className="max-w-full ">
              <div className="relative shadow-xl sm:rounded-none sm:overflow-hidden">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 items-center lg:px-8"
